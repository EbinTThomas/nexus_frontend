...
export default function SignUpPage() {
    ...
    const [formData, setFormData] = useState<FormData>({ email: '', organisation: '', password: '' });
    ...
    const validateForm = (): boolean => {
        return formData.email !== '' && formData.organisation !== '' && formData.password !== '';
    };
